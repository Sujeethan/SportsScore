...
public class CricketScheduleRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private final Context mcontext;
    private final List<Map<String,?>> mDataSet;
    private final int mType;
    OnItemClickListener mItemClickListener;
    public CricketScheduleRecyclerViewAdapter(Context mycontext, List<Map<String, ?>> myDataSet, int type) {
       mcontext = mycontext;
      mDataSet = myDataSet;
      mType = type;
    }
    public class ListViewHolder extends RecyclerView.ViewHolder{
        ...
        public TextView vMatch1;
        public TextView vMatch2;
        public TextView vMatch3;
        public TextView vMatch4;
        public TextView vMatch5;
        ...
        public ListViewHolder(View v){
            ...
            /*vMatch1 = (TextView)v.findViewById(R.id.match1);
            vMatch2 = (TextView)v.findViewById(R.id.match2);
            vMatch3 = (TextView)v.findViewById(R.id.match3);
            vMatch4 = (TextView)v.findViewById(R.id.match4);
            vMatch5 = (TextView)v.findViewById(R.id.match5);*/
        ...
        public void bindMovieData(Map<String, ?> match){
            ...
            /*vMatch1.setText((String) match.get("Match1"));
            vMatch2.setText((String) match.get("Match2"));
            vMatch3.setText((String) match.get("Match3"));
            vMatch4.setText((String) match.get("Match4"));
            vMatch5.setText((String) match.get("Match5"));*/
